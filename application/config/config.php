...
|
*/
$config['encryption_key'] = 'encryption_key can\'t be shared';
...
$config['access_key'] = 'access_key can\'t be shared';
...
$config['secret_key'] = 'secret_key can\'t be shared';
...
|--------------------------------------------------------------------------
|
| Get Settings from environment instead of this file?
...
|--------------------------------------------------------------------------
|
| Name for access key in environment
|
*/
...
/*
|--------------------------------------------------------------------------
| If get from environment, do so and overwrite fixed vars above
|--------------------------------------------------------------------------
|
*/
